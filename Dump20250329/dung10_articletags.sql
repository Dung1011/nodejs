...
CREATE TABLE `articletags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `articletags_ibfk_1` FOREIGN KEY (`article_id`) REFERENCES `articles` (`article_id`),
  CONSTRAINT `articletags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`tag_id`)
